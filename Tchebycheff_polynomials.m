...
% downloaded from 
% https://github.com/JSaulRivera/Computation-of-2D-and-3D-high-order-discrete-orthogonal-moments.git


%This code calculate the discrete orthogonal Tchebichef polynomial for high order, using Gram-smith orthogonalization.
